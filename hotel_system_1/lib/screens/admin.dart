  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: isSmallScreen
          ? AppBar(
              title: const Text('BOOKTOPIA Admin',
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Icon(icon, color: Colors.white, size: isSmallScreen ? 26 : 32),
  ...
  Widget _buildWebSidebar() {
    return ListView(
      children: [
        const DrawerHeader(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text('Booktopia Admin',
                  style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
            ],
          ),
        ),
        _buildDrawerItem(Icons.dashboard, 'Dashboard', () {}),
        _buildDrawerItem(Icons.home_work, 'Add Rooms', () async {
        ...
        _buildDrawerItem(Icons.receipt_long, 'Transactions', () {
  Navigator.push(
    context,
