      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Welcome to Booktopia! These Terms & Conditions ("Terms") govern your access to and use of the Booktopia website, mobile applications, and services (collectively, the "Service"). By accessing or using the Service, you agree to be bound by these Terms and our Privacy Policy. If you do not agree to these Terms, please do not use the Service.',
              style: TextStyle(
            ...
            const SizedBox(height: 8.0),
            Text(
              'All bookings made through the Service are subject to the hotel\'s terms and conditions, including cancellation policies. You agree to pay all charges incurred by you or on your behalf through the Service, at the prices in effect when such charges are incurred. You are responsible for any applicable taxes. All payments are processed securely through our third-party payment gateway. Booktopia is not responsible for any issues arising from payment processing.',
            ...
            const SizedBox(height: 8.0),
            Text(
              'If you have any questions about these Terms, please contact us at support@booktopia.com.',
              style: TextStyle(fontSize: 15.0, color: kGreyText),
            ),
