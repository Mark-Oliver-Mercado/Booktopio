...
class TransactionScreenContent extends StatelessWidget {
  // Renamed to TransactionScreenContent
  TransactionScreenContent({Key? key}) : super(key: key);

  // Sample data for hotel booking transactions.
  final List<Transaction> transactions = [
    Transaction(
      ...
      numberOfNights: 2,
      totalPrice: 7000,
      checkInDate: DateTime(2025, 7, 20),
      checkInTime: TimeOfDay(hour: 14, minute: 0),
      checkOutDate: DateTime(2025, 7, 22),
      checkOutTime: TimeOfDay(hour: 12, minute: 0),
    ...
    Transaction(
      ...
      checkInTime: TimeOfDay(hour: 13, minute: 0),
      checkOutDate: DateTime(2025, 7, 20),
      checkOutTime: TimeOfDay(hour: 11, minute: 0),
      paymentMethod: 'Gcash',
    ...
    Transaction(
      ...
      checkInTime: TimeOfDay(hour: 15, minute: 30),
    ...
    Transaction(
      ...
      checkInTime: TimeOfDay(hour: 14, minute: 0),
      checkOutDate: DateTime(2025, 7, 19),
      checkOutTime: TimeOfDay(hour: 11, minute: 0),
      paymentMethod: 'Cash',
    ...
    Transaction(
      ...
      checkInTime: TimeOfDay(hour: 16, minute: 0),
      checkOutDate: DateTime(2025, 7, 16),
      checkOutTime: TimeOfDay(hour: 12, minute: 0),
      paymentMethod: 'Credit Card',
    ...
    Transaction(
      ...
      numberOfNights: 2,
      totalPrice: 3000,
      checkInDate: DateTime(2025, 7, 13),
      checkInTime: TimeOfDay(hour: 13, minute: 0),
    ...
    Transaction(
      ...
      checkInTime: TimeOfDay(hour: 14, minute: 0),
      checkOutDate: DateTime(2025, 7, 12),
      checkOutTime: TimeOfDay(hour: 12, minute: 0),
      paymentMethod: 'Credit Card',
    ...
    Transaction(
      ...
      numberOfNights: 1,
      totalPrice: 2500,
      checkInDate: DateTime(2025, 7, 9),
      checkInTime: TimeOfDay(hour: 14, minute: 0),
      checkOutDate: DateTime(2025, 7, 10),
      checkOutTime: TimeOfDay(hour: 11, minute: 0),
      paymentMethod: 'PayPal',
    ...
    Transaction(
      ...
      numberOfNights: 3,
      totalPrice: 8400,
      checkInDate: DateTime(2025, 7, 6),
      checkInTime: TimeOfDay(hour: 15, minute: 0),
      checkOutDate: DateTime(2025, 7, 9),
      checkOutTime: TimeOfDay(hour: 12, minute: 0),
      paymentMethod: 'Credit Card',
    ...
    Transaction(
      ...
      checkInTime: TimeOfDay(hour: 14, minute: 0),
      checkOutDate: DateTime(2025, 7, 6),
      checkOutTime: TimeOfDay(hour: 12, minute: 0),
      paymentMethod: 'Bank Transfer',
      specialRequests: 'VIP access',
    ),
  ];
            ...
            Align(
              ...
              child: const Text(
                ...
                style: TextStyle(
                  ...
                  color: Color(0xFF333333), // Using kDarkText if defined
                ),
              ),
            ),
